...
//load assest
loadSprite("bird","www/sprites/bird.png");
loadSprite("bg","www/sprites/bg.png");
loadSprite("bpipe","www/sprites/pipe.png");
...
// Load sounds
loadSound("jump", "www/sounds/jump.mp3");
loadSound("bruh", "www/sounds/bruh.mp3");
loadSound("pass", "www/sounds/pass.mp3");
...
scene("game", () => {
	...
	function createPipes() {
		...
		//top pipe
		add([
			sprite("www/sprites/pipe.png", { flipY: true }),
			pos(width(), height() / 2 + offset + PIPE_GAP / 2),
			"pipe",
			anchor("botleft"),
			scale(2),
